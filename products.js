window.PRODUCT_DATA = {
  ...
  rawProducts: [
            ...
            { id: "7891058005474", cat: 'Dorflex', name: 'Dorflex Dip 1g – 10 Cpr', base: 13.31, curva: 'A', tiers: [ {q:1, p:11.71, d:12}, {q:10, p:9.32, d:30}, {q:20, p:7.32, d:45} ] },
            ...
            { id: "7891058000103", cat: 'Dorflex', name: 'Dorflex Uno 1g – 20 Cpr', base: 24.01, curva: 'B', tiers: [ {q:1, p:22.33, d:7}, {q:3, p:21.37, d:11}, {q:4, p:21.13, d:12} ] },
            ...
            { id: "7891058016999", cat: 'Enterogermina', name: 'Enterogermina 2 BCFU 10 flac', base: 43.05, curva: 'A', tiers: [ {q:1, p:38.31, d:11}, {q:6, p:36.59, d:15}, {q:14, p:35.73, d:17}, {q:30, p:31.86, d:26}, {q:40, p:30.14, d:30} ], isCampaign: true },
            { id: "7891058017002", cat: 'Enterogermina', name: 'Enterogermina 2 BCFU 20 flac', base: 68.11, curva: 'B', tiers: [ {q:1, p:60.62, d:11}, {q:3, p:57.89, d:15}, {q:4, p:56.53, d:17}, {q:10, p:50.40, d:26}, {q:15, p:47.68, d:30} ], isCampaign: true },
            { id: "7891058006501", cat: 'Enterogermina', name: 'Enterogermina 2 BCFU 5 flac', base: 28.67, curva: 'B', tiers: [ {q:1, p:25.52, d:11}, {q:3, p:24.37, d:15}, {q:4, p:23.80, d:17}, {q:10, p:21.22, d:26}, {q:15, p:20.07, d:30} ], isCampaign: true },
            { id: "7891058022594", cat: 'Enterogermina', name: 'Enterogermina Plus 4 BCFU 10 flac', base: 70.09, curva: 'B', tiers: [ {q:1, p:62.38, d:11}, {q:3, p:59.58, d:15}, {q:4, p:58.17, d:17}, {q:10, p:51.87, d:26}, {q:15, p:49.06, d:30} ], isCampaign: true },
            { id: "7891058020286", cat: 'Enterogermina', name: 'Enterogermina Plus 4 BCFU 5 flac', base: 44.29, curva: 'A', tiers: [ {q:1, p:39.42, d:11}, {q:5, p:37.65, d:15}, {q:10, p:36.76, d:17}, {q:18, p:32.77, d:26}, {q:30, p:31.00, d:30} ], isCampaign: true },
            ...
            { id: "7891058006716", cat: 'Allegra', name: 'Allegra D – 10 Cpr', base: 55.74, curva: 'B', tiers: [ {q:1, p:51.84, d:7}, {q:2, p:50.72, d:9}, {q:3, p:49.61, d:11} ] },
            ...
            { id: "7891058002565", cat: 'Novalgina', name: 'Novalgina 1g – 20 Cpr', base: 35.93, curva: 'B', tiers: [ {q:1, p:33.41, d:7}, {q:4, p:32.70, d:9}, {q:6, p:31.98, d:11} ] },
            ...
            { id: "7891058015770", cat: 'Novalgina', name: 'Novalgina 1g – 100 Cpr Eferv. (Display)', base: 299.94, curva: 'E', tiers: [ {q:1, p:266.95, d:11} ], fraction: { unit: 'Env (2un)', divisor: 50 } },
            ...
            { id: "7891058005993", cat: 'Novalgina', name: 'Novalgina Flash 8 Cpr (Pré-Pedido)', base: 19.71, curva: 'E', tiers: [ {q:1, p:18.13, d:8}, {q:4, p:17.94, d:9}, {q:8, p:17.54, d:11}, {q:15, p:15.97, d:19}, {q:30, p:15.18, d:23}, {q:120, p:11.83, d:40} ], isCampaign: true, image: "https://drogariasp.vteximg.com.br/arquivos/ids/1614175-176-176/909530---Analgesico-Novalgina-Flash-1g-130mg-8-Comprimidos-1.jpg?v=639052175863030000" },
            ...
            // ANADOR
            { id: "7891058003890", cat: 'Anador', name: 'Anador 1g – 10 Cpr', base: 13.00, curva: 'A', tiers: [ {q:1, p:10.79, d:17}, {q:60, p:8.45, d:35}, {q:120, p:7.15, d:45} ] },
            { id: "7891058003883", cat: 'Anador', name: 'Anador 1g – 20 Cpr', base: 23.40, curva: 'E', tiers: [ {q:1, p:19.89, d:15}, {q:60, p:15.21, d:35}, {q:120, p:12.87, d:45} ] },
            ...
            { id: "7891058021597", cat: 'Anador', name: 'Anador 500mg – 24 Cpr (Suz)', base: 22.91, curva: 'B', tiers: [ {q:1, p:20.16, d:12}, {q:60, p:14.89, d:35}, {q:120, p:12.60, d:45} ] },
            ...
            { id: "7891058005467", cat: 'Targifor', name: 'Targifor C 1g Eferv – 16 Cpr', base: 32.83, curva: 'A', tiers: [ {q:1, p:29.55, d:10}, {q:4, p:27.91, d:15}, {q:8, p:26.26, d:20} ] },
            ...
            { id: "7891058020316", cat: 'Moura', name: 'Colírio Moura – 20ml', base: 22.21, curva: 'A', tiers: [ {q:1, p:20.66, d:7}, {q:5, p:20.21, d:9}, {q:10, p:19.77, d:11}, {q:12, p:17.55, d:21} ], isCampaign: true },
            ...
            { id: "7891058022730", cat: 'Oscal', name: 'Oscal D 500mg + 1000UI – 60 Cpr', base: 117.66, curva: 'D', tiers: [ {q:1, p:107.07, d:9} ] },
            ...
            { id: "7896070600447", cat: 'Fenergan', name: 'Fenergan 25mg – 20 Cpr', base: 15.26, curva: 'B', tiers: [ {q:1, p:14.19, d:7}, {q:3, p:13.89, d:9}, {q:6, p:13.58, d:11} ] },
